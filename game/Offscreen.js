 ...
 */
var ol_Offscreen = function(options) {
  options = options || {};
  ol_Object.call (this);
...
/** Change size
*/
ol_Offscreen.prototype.changeSize_ = function() {
...
*/
ol_Offscreen.prototype.getPixelValue = function(pixel) {
  var val = null;
...
* @return {Array} an array representing [R, G, B, A] pixel values (0 - 255) or null if no pixel
*/
ol_Offscreen.prototype.getValue = function(coord) {
